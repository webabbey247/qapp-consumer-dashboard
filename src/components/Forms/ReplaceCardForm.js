                ...
                <CardContainer>
                    <ContentRow>
                        <ContentFullColumn>
                            ...
                            <GeneralSmText fontSize="12px" lineHeight="16px" textAlign="center" color="#F7F7F7" fontWeight="400" textTransform="Capitalize" margin="0.5rem 0">Kindly proceed to your bank to pick up
your card.</GeneralSmText>
                        </ContentFullColumn>
